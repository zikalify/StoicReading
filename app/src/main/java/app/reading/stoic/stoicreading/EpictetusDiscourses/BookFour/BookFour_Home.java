...
public class BookFour_Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = findViewById(R.id.BookFour_1);
        button.setOnClickListener(v -> BookFour_1());

        button = findViewById(R.id.BookFour_2);
        button.setOnClickListener(v -> BookFour_2());

        button = findViewById(R.id.BookFour_3);
        button.setOnClickListener(v -> BookFour_3());

        button = findViewById(R.id.BookFour_4);
        button.setOnClickListener(v -> BookFour_4());

        button = findViewById(R.id.BookFour_5);
        button.setOnClickListener(v -> BookFour_5());

        button = findViewById(R.id.BookFour_6);
        button.setOnClickListener(v -> BookFour_6());

        button = findViewById(R.id.BookFour_7);
        button.setOnClickListener(v -> BookFour_7());

        button = findViewById(R.id.BookFour_8);
        button.setOnClickListener(v -> BookFour_8());

        button = findViewById(R.id.BookFour_9);
        button.setOnClickListener(v -> BookFour_9());

        button = findViewById(R.id.BookFour_10);
        button.setOnClickListener(v -> BookFour_10());

        button = findViewById(R.id.BookFour_11);
        button.setOnClickListener(v -> BookFour_11());

        button = findViewById(R.id.BookFour_12);
        button.setOnClickListener(v -> BookFour_12());

        button = findViewById(R.id.BookFour_13);
        button.setOnClickListener(v -> BookFour_13());
    }
